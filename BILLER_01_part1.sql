...
begin
   ...
   dbms_output.put_line('--START TRF_SPOOL');
   for vstr in (select '    BILLER.MOVE_IOT_TABLE.TRF_SPOOL('''||partition_name||''','''||to_TS||''');' as a
                from user_segments
                where segment_name like 'TRF_SPOOL_PK'
   ...
   dbms_output.put_line('--END TRF_SPOOL');
   dbms_output.put_line(' ');
   dbms_output.put_line(' ');
   dbms_output.put_line(' ');
   dbms_output.put_line(' ');
   dbms_output.put_line('--START TRF_SPOOL_VPN');
   for vstr in (select '    BILLER.MOVE_IOT_TABLE.TRF_SPOOL_VPN('''||partition_name||''','''||to_TS||''');' as a
                from user_segments
                where segment_name like 'TRF_SPOOL_VPN_PK'
                and partition_name like PART_NAME||'%'
                and tablespace_name = from_TS
                order by partition_name)
   loop
   ...
   dbms_output.put_line('--END TRF_SPOOL_VPN');
